...
EXPECTED = {
    ('a cell is never revealed twice', (('cell', '0,0'), ('game_id', 'game-dup')), 'violated'),
    ('no cell is revealed after a mine explodes', (('game_id', 'game-boom'),), 'violated'),
    ('no cell is revealed after a mine explodes', (('game_id', 'game-healthy'),), 'satisfied'),
    ('planted flags never outnumber the mines', (('game_id', 'game-flags'),), 'violated'),
    ('planted flags never outnumber the mines', (('game_id', 'game-healthy'),), 'satisfied'),
}
