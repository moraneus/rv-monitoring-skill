...
EXPECTED = {
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-borrow-return'),), 'satisfied'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-horizon'),), 'satisfied'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-lost'),), 'satisfied'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-lost-then-renew'),), 'satisfied'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-overdue'),), 'violated'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-renew-return'),), 'satisfied'),
    ('a borrowed loan is returned, renewed, or reported lost within 21 seconds', (('loan_id', 'L-return-then-renew'),), 'satisfied'),
    ('a loan can only be renewed after it was borrowed', (('loan_id', 'L-lost-then-renew'),), 'satisfied'),
    ('a loan can only be renewed after it was borrowed', (('loan_id', 'L-renew-first'),), 'violated'),
    ('a loan can only be renewed after it was borrowed', (('loan_id', 'L-renew-return'),), 'satisfied'),
    ('a loan can only be renewed after it was borrowed', (('loan_id', 'L-return-then-renew'),), 'satisfied'),
    ('a loan can only be returned after it was borrowed', (('loan_id', 'L-borrow-return'),), 'satisfied'),
    ('a loan can only be returned after it was borrowed', (('loan_id', 'L-horizon'),), 'satisfied'),
    ('a loan can only be returned after it was borrowed', (('loan_id', 'L-renew-return'),), 'satisfied'),
    ('a loan can only be returned after it was borrowed', (('loan_id', 'L-return-first'),), 'violated'),
    ('a loan can only be returned after it was borrowed', (('loan_id', 'L-return-then-renew'),), 'satisfied'),
    ('a returned loan is never renewed afterwards', (('loan_id', 'L-return-then-renew'),), 'violated'),
    ('once a loan is reported lost it must never be renewed', (('loan_id', 'L-lost-then-renew'),), 'violated'),
}
