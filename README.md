...
Either way, target projects need `pip install behave-rv` (>= 0.5.0 for the
coverage step in the workflow; the core works from 0.3.1; Python 3.10+) - the
package ships the complete behave-rv documentation
